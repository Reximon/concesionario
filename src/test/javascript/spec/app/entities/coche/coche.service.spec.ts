...
describe('Service Tests', () => {
  describe('Coche Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Coche(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Coche', async () => {
      ...
      it('should update a Coche', async () => {
        const returnedFromService = Object.assign(
          {
            audi: 'BBBBBB'
          },
      ...
      it('should return a list of Coche', async () => {
        const returnedFromService = Object.assign(
          {
            audi: 'BBBBBB'
          },
      ...
      it('should delete a Coche', async () => {
